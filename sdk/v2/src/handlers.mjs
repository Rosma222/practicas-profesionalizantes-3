...
// Parsea el body de una petición POST o PUT.
 ...
 * Alta pública de usuario (rol "usuario" por defecto)
 */
...
/**
 * Handler para POST /usuarios/crear
 * Alta de usuario con rol elegido (uso administrativo)
 */
...
/**
 * Handler para DELETE /usuarios/eliminar
 * Baja de usuario. El id viene como parámetro en la URL: /usuarios/eliminar?id=5
 */
...
/**
 * Handler para PUT /usuarios/modificar
 * Modificación de usuario. Los datos vienen en el body.
 */
...
/**
 * Handler para GET /usuarios/listar
...
/**
 * Handler para GET /usuarios/buscar
 * Busca un usuario por id. Ej: /usuarios/buscar?id=3
 */
...
/**
 * Handler para DELETE /roles/eliminar
 * El id y nombre vienen como parámetros en la URL: /roles/eliminar?id=3&nombre=editor
 */
...
/**
 * Handler para POST /permisos/asignar
 */
...
/**
 * Handler para DELETE /permisos/revocar
 * El id viene como parámetro en la URL: /permisos/revocar?id=2
 */
...
/**
 * Handler para GET /permisos/listar
 * Lista permisos de un rol. Ej: /permisos/listar?rol_id=1
 */
