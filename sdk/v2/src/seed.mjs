/**
 * SCRIPT DE INSERCIÓN MASIVA — solo para pruebas y experimentación
 * 
 * Cómo usarlo:
 *   1. Asegurate de haber corrido el servidor al menos una vez
 *      para que las tablas ya existan en la base de datos.
 *   2. Desde la carpeta sdk/v2 (no desde src/), ejecutá:
 *      node src/seed.mjs
 *   3. El script inserta roles, usuarios y permisos de prueba.
 *   4. Podés correrlo solo una vez. Si lo corrés de nuevo,
 *      los registros duplicados se ignorarán (INSERT OR IGNORE).
 */
...
async function seed() {
  ...
  // Acá agregamos roles extra para experimentar.
  // ═══════════════════════════════════════════════════════
  ...
  // ═══════════════════════════════════════════════════════
  // USUARIOS
  // 40 usuarios de prueba distribuidos entre los 6 roles.
  // Las contraseñas son texto plano solo para pruebas.
  // ═══════════════════════════════════════════════════════
  ...
  // ═══════════════════════════════════════════════════════
  // PERMISOS
  // Asignamos acciones típicas a cada rol para experimentar
  // con consultas de permisos.
  // ═══════════════════════════════════════════════════════
  ...
  console.log('Queries de ejemplo para experimentar:');
  console.log('');
